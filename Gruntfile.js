module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      scripts: {
        ...
        rename: function(dest, src) {
          return dest + src.replace('scripts','vaccine-versions');
        }
      }
    },
    concat: {
    ...
    uglify: {
      dist: {
        files: {
          'dist/vaccine-versions.template.min.js': ['.tmp/scripts.template.js'],
          'dist/vaccine-versions.min.js': ['.tmp/scripts.js']
        }
      }
    },
    html2js: {
      dist: {
        ...
        module: 'eha.vaccine-versions.template',
        options: {
